...
const quotes = [
  ...
  { text: "\"K5GFL\" is recorded in front of a live studio audience"},
  ...
  { text: "It is so over"},
  { text: "We are so back"},
  { text: "The amateur radio community is more weeb than you think. After all, all their radios come from Japan!"},
  { text: "<em><strong>b r e a d b o a r d</strong></em>"},
  { text: "Nobody tell the SSTV boomers about AI please"},
  { text: "Actually sends QSL cards now!"},
  { text: "Merry Crimbo"},
  { text: "More than just a dream..."},
  { text: "My name is K5 \"Joe Mama\" GFL"},
  { text: "On that quotes grind yuh yuh on the quotes grind"},
  { text: "<em><strong>MORTAL KOOMMBATTTTTTTT!!!</strong></em>"},
  { text: "\"What?\"", author: "- Norm Macdonald"},
  { text: "One Flew Over The Antenna Tower"},
  { text: "I'm K5GFL and I approve this message"},
  { text: "Sixteen times the contacts"},
  { text: "VGH..."},
  { text: "Everybody in this hobby is a boomer in their own way. How many kids these days understand the art of the Sparta kick?"},
  { text: "HAM RADIO MENTIONED?!"},
  { text: "Yes, turning your property into one big VLF transmission antenna will attract the attention of your neighbors, the police, your power company and God. But think of the seven other lunatics you can talk to!", author: "(I want to be one of them one day)"},
  { text: "dead bands lol"},
  { text: "It's 10 PM. Do you know where your children are?"},
  { text: "Ionospheric conditions? Where we're going, we don't need ionospheric conditions.<br /><em>revs up AC alternator</em>"},
  { text: "Say My Callsign"},
